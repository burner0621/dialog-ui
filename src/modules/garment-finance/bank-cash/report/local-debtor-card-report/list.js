...
export class List {
    ...
    fillTable() {
        const columns = [
            ...
            { field: "JLDate", title: "Tanggal", sortable: false},
            { field: "SalesNoteNoJL", title: "No. Nota Penjualan", sortable: false},
            { field: "SellAmount", title: "Jumlah", sortable: false, align: "right"},
            
            { field: "BYDate", title: "Tanggal Kwitansi", sortable: false,},
            { field: "ReceiptNo", title: "No. Kwitansi", sortable: false},
            { field: "SalesNoteBY", title: "No. Nota Penjualan (dibayar)", sortable: false},
            { field: "PaidAmount", title: "Jumlah Kwitansi", sortable: false, align: "right"},
