         ...
         this.service.search(info)
            .then(result => {
                  ...
                  for (var data of result.data) {
                       var Buyer = data.marketingName;
                        if (!dataByBuyer[Buyer]) dataByBuyer[Buyer] = [];                 
                            ...
                            packsQuantity : data.packsQuantity.toLocaleString('en-EN', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),                           
                        ...
                        if (!subTotalBuyer3[Buyer]) {
                           ...
                           subTotalBuyer3[Buyer] += data.packsQuantity;
               ...
               for (var data in dataByBuyer) {
                   ...
                   buyer: dataByBuyer[data][0].marketingName,
                   ...
                   this.TotPacks += subTotalBuyer3[data];                    
               ...
               this.TotPacks = this.TotPacks.toLocaleString('en-EN', { minimumFractionDigits: 2, maximumFractionDigits: 2 });               
