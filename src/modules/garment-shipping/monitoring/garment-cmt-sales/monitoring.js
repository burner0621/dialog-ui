            ...
            .then(result => {
                  ...
                  for (var item of this.data){
                     ...
                     // item.paymentDate=moment(item.paymentDate).format("DD MMM YYYY")=="01 Jan 1970" ? "-" : moment(item.paymentDate).format("DD MMM YYYY");
                      ...
                      item.fob=item.fob.toLocaleString('en-EN',{minimumFractionDigits: 2, maximumFractionDigits: 2});
                      item.fobIdr=item.fobIdr.toLocaleString('en-EN',{minimumFractionDigits: 2, maximumFractionDigits: 2});
                      item.fab=item.fab.toLocaleString('en-EN',{minimumFractionDigits: 2, maximumFractionDigits: 2});
                      item.fabIdr=item.fabIdr.toLocaleString('en-EN',{minimumFractionDigits: 2, maximumFractionDigits: 2});
                      item.toBePaid=item.toBePaid.toLocaleString('en-EN',{minimumFractionDigits: 2, maximumFractionDigits: 2});
                      item.toBePaidIdr=item.toBePaidIdr.toLocaleString('en-EN',{minimumFractionDigits: 2, maximumFractionDigits: 2});
                    //   item.toBePaid=item.toBePaid.toLocaleString('en-EN',{minimumFractionDigits: 2, maximumFractionDigits: 2});
