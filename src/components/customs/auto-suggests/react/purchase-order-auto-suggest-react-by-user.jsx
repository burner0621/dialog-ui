...
export default class PurchaseOrderAutoSuggestReactByUser extends AutoSuggestReact {
    constructor(props) {
        super(props);
    }

    init(props) {
        var options = Object.assign({}, PurchaseOrderAutoSuggestReactByUser.defaultProps.options, props.options);
...
PurchaseOrderAutoSuggestReactByUser.propTypes = {
...
PurchaseOrderAutoSuggestReactByUser.defaultProps = {
    options: {
        readOnly: false,
